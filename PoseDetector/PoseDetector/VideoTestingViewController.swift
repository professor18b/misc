...
class VideoTestingViewController: UIViewController {
    ...
    private func getPoints(detectedResult: DetectedResult) -> String? {
        ...
        for joints in detectedResult.joints {
            ...
            isFirst = false
            result.append("[")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.nose, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.neck, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.rightShoulder, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.rightElbow, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.rightWrist, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.leftShoulder, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.leftElbow, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.leftWrist, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.root, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.rightHip, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.rightKnee, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.rightAnkle, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.leftHip, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.leftKnee, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.leftAnkle, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.rightEye, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.leftEye, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.rightEar, joins: joints, size: detectedResult.size))
            result.append(",")
            result.append(getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName.leftEar, joins: joints, size: detectedResult.size))
    ...
    private func getFrameJoint(jointName: VNHumanBodyPoseObservation.JointName, joins: [VNHumanBodyPoseObservation.JointName : VNRecognizedPoint], size: CGSize) -> String {
